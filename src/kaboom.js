var kaboom = (() => {
  ...
  var wi = (s, t, c) =>
    t in s
      ? yt(s, t, { enumerable: !0, configurable: !0, writable: !0, value: c })
      : (s[t] = c);
  var o = (s, t) => yt(s, 'name', { value: t, configurable: !0 });
  var dr = (s, t) => {
      for (var c in t) yt(s, c, { get: t[c], enumerable: !0 });
    },
    bi = (s, t, c, g) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let U of pi(t))
          !gi.call(s, U) &&
            ...
            yt(s, U, {
              get: () => t[U],
              enumerable: !(g = mi(t, U)) || g.enumerable,
            });
      return s;
    };
  var vi = (s) => bi(yt({}, '__esModule', { value: !0 }), s);
  var Ee = (s, t, c) => (wi(s, typeof t != 'symbol' ? t + '' : t, c), c);
  var yi = (() => {
  ...
  o(Me, 'lerp');
  function zt(s, t, c, g, U) {
    return g + ((s - t) / (c - t)) * (U - g);
  }
  o(zt, 'map');
  function mr(s, t, c, g, U) {
    return Ne(zt(s, t, c, g, U), g, U);
  }
  o(mr, 'mapc');
  var be = class {
      x = 0;
  ...
  o(W, 'rgb');
  var pr = o((s, t, c) => L.fromHSL(s, t, c), 'hsl2rgb'),
    Q = class {
      x = 0;
      y = 0;
      w = 1;
      h = 1;
      constructor(t, c, g, U) {
        (this.x = t), (this.y = c), (this.w = g), (this.h = U);
      }
      scale(t) {
        return new Q(
          this.x + this.w * t.x,
  ...
  var J = class {
    ...
    mult(t) {
      ...
      for (let g = 0; g < 4; g++)
        for (let U = 0; U < 4; U++)
          c[g * 4 + U] =
            this.m[0 * 4 + U] * t.m[g * 4 + 0] +
            this.m[1 * 4 + U] * t.m[g * 4 + 1] +
            this.m[2 * 4 + U] * t.m[g * 4 + 2] +
            this.m[3 * 4 + U] * t.m[g * 4 + 3];
      return new J(c);
    }
    multVec2(t) {
      return new v(
    ...
    invert() {
      ...
      (t[0] = this.m[5] * c - this.m[6] * g + this.m[7] * U),
        (t[4] = -(this.m[4] * c - this.m[6] * M + this.m[7] * z)),
        (t[8] = this.m[4] * g - this.m[5] * M + this.m[7] * I),
        (t[12] = -(this.m[4] * U - this.m[5] * z + this.m[6] * I)),
        (t[1] = -(this.m[1] * c - this.m[2] * g + this.m[3] * U)),
        (t[5] = this.m[0] * c - this.m[2] * M + this.m[3] * z),
        (t[9] = -(this.m[0] * g - this.m[1] * M + this.m[3] * I)),
        (t[13] = this.m[0] * U - this.m[1] * z + this.m[2] * I),
        (t[2] = this.m[1] * k - this.m[2] * Z + this.m[3] * ce),
        (t[6] = -(this.m[0] * k - this.m[2] * E + this.m[3] * X)),
        (t[10] = this.m[0] * h - this.m[1] * E + this.m[3] * K),
  ...
  var xi = 1103515245,
    ...
    rt = class {
      ...
      gen() {
        return (this.seed = (xi * this.seed + Ui) % fr), this.seed / fr;
      }
      genNumber(t, c) {
  ...
  o(nt, 'testLineLine');
  function yr(s, t) {
    if (xt(s, t.p1) || xt(s, t.p2)) return !0;
    let c = s.points();
    return (
      !!nt(t, new Se(c[0], c[1])) ||
      !!nt(t, new Se(c[1], c[2])) ||
  ...
  function Er(s, t) {
    ...
    return Ur(s, t.pts[0]) ? !0 : Fn(t, s.center);
  }
  o(Er, 'testCirclePolygon');
  function Fn(s, t) {
    let c = !1,
      g = s.pts;
    for (let U = 0, M = g.length - 1; U < g.length; M = U++)
      g[U].y > t.y != g[M].y > t.y &&
        t.x <
          ((g[M].x - g[U].x) * (t.y - g[U].y)) / (g[M].y - g[U].y) + g[U].x &&
        (c = !c);
    return c;
  }
  ...
  function Sr(s, t) {
    let c = Number.MAX_VALUE,
      g = S(0);
    for (let U of [s, t])
      for (let M = 0; M < U.pts.length; M++) {
        let z = U.pts[M],
          k = U.pts[(M + 1) % U.pts.length].sub(z).normal().unit(),
          Z = Number.MAX_VALUE,
          ce = -Number.MAX_VALUE;
        ...
        for (let K = 0; K < t.pts.length; K++) {
          ...
          (E = Math.min(E, pe)), (X = Math.max(X, pe));
        }
        let h = Math.min(ce, X) - Math.max(Z, E);
        if (h < 0) return null;
        if (h < Math.abs(c)) {
          let K = X - Z,
            pe = E - ce;
  ...
  function Bn(s, t) {
    ...
    if (c === 'object' && g === 'object' && s !== null && t !== null) {
      ...
      for (let z of U) {
        let I = s[z],
          k = t[z];
        if (!(typeof I == 'function' && typeof k == 'function') && !Bn(I, k))
          return !1;
      }
      return !0;
    }
  ...
  function Si(s) {
    let t = window.atob(s),
      c = t.length,
      g = new Uint8Array(c);
    for (let U = 0; U < c; U++) g[U] = t.charCodeAt(U);
    return g.buffer;
  }
  o(Si, 'base64ToArrayBuffer');
  function Cr(s) {
    return Si(s.split(',')[1]);
  }
  o(Cr, 'dataURLToArrayBuffer');
  function Kt(s, t) {
  ...
  var Et = class {
    ...
    remove() {
      ...
      let t = this._items[0],
        c = this._items.pop();
      return (
        this._items.length !== 0 && ((this._items[0] = c), this.moveDown(0)), t
      );
    }
    clear() {
  ...
  var Pr = o((s) => {
      ...
      let b = 0,
        C = o((ee) => {
          ...
          (t.realTime = re),
            ...
            b > Oe &&
              (t.skipTime ||
                ((t.dt = b), (t.time += g()), t.fpsCounter.tick(t.dt)),
              (b = 0),
              (t.skipTime = !1),
              t.numFrames++,
              Gt(),
        ...
        for (let V = 0; V < b.buttons.length; V++)
          b.buttons[V].pressed
            ? (re.buttonState.down.has(ee.buttons[V]) ||
                (t.mergedGamepadState.buttonState.press(ee.buttons[V]),
                re.buttonState.press(ee.buttons[V]),
                t.events.trigger('gamepadButtonPress', ee.buttons[V])),
    ...
    (de.keydown = (d) => {
      wn.has(d.key) && d.preventDefault(),
        t.events.onOnce('input', () => {
          let b = Lt[d.key] || d.key.toLowerCase();
          b.length === 1
    ...
    return (
      It.observe(t.canvas),
      {
        ...
        isKeyDown: lt,
        isKeyPressed: Fe,
        isKeyPressedRepeat: tn,
        isKeyReleased: We,
        isMouseDown: B,
        isMousePressed: xe,
        isMouseReleased: T,
        isMouseMoved: ct,
        isGamepadButtonPressed: nn,
        isGamepadButtonDown: rn,
        ...
        onTouchEnd: dn,
        onScroll: fn,
        onGamepadButtonDown: At,
        onGamepadButtonPress: Ot,
        onGamepadButtonRelease: Pt,
        onGamepadStick: Rt,
        onGamepadConnect: Mt,
        onGamepadDisconnect: mn,
        events: t.events,
        get paused() {
          return t.paused;
        },
  ...
  var Wt = 2.5949095,
    ...
    Jt = {
      ...
      easeInBack: (s) => Rr * s * s * s - 1.70158 * s * s,
      easeOutBack: (s) =>
        1 + Rr * Math.pow(s - 1, 3) + 1.70158 * Math.pow(s - 1, 2),
      easeInOutBack: (s) =>
        s < 0.5
          ? (Math.pow(2 * s, 2) * ((Wt + 1) * 2 * s - Wt)) / 2
          : (Math.pow(2 * s - 2, 2) * ((Wt + 1) * (s * 2 - 2) + Wt) + 2) / 2,
      easeInElastic: (s) =>
        s === 0
          ? 0
          : s === 1
            ? 1
            : -Math.pow(2, 10 * s - 10) * Math.sin((s * 10 - 10.75) * Mr),
      easeOutElastic: (s) =>
        s === 0
          ? 0
          : s === 1
            ? 1
            : Math.pow(2, -10 * s) * Math.sin((s * 10 - 0.75) * Mr) + 1,
      easeInOutElastic: (s) =>
        s === 0
          ? 0
          : s === 1
            ? 1
            : s < 0.5
              ? -(Math.pow(2, 20 * s - 10) * Math.sin((20 * s - 11.125) * Dr)) /
                2
              : (Math.pow(2, -20 * s + 10) * Math.sin((20 * s - 11.125) * Dr)) /
                  2 +
                1,
      easeInBounce: (s) => 1 - Jt.easeOutBounce(1 - s),
      easeOutBounce: (s) =>
        s < 1 / 2.75
          ? 7.5625 * s * s
          : s < 2 / 2.75
      ...
      easeInOutBounce: (s) =>
        s < 0.5
          ? (1 - Jt.easeOutBounce(1 - 2 * s)) / 2
          : (1 + Jt.easeOutBounce(2 * s - 1)) / 2,
    },
    ot = Jt;
  var at = class {
    time;
...
`,
  ...
  var _i = o((s = {}) => {
    ...
    let c =
      ...
      g = s.scale ?? 1,
      U = s.width && s.height && !s.stretch && !s.letterbox;
    U
    ...
    class K {
      ...
      update(n, r = 0, i = 0) {
        this.bind(),
          h.texSubImage2D(h.TEXTURE_2D, 0, r, i, h.RGBA, h.UNSIGNED_BYTE, n),
          this.unbind();
      }
      bind() {
    ...
    let w = (() => {
      let e = ft(kn, _n),
        ...
        r =
          s.width && s.height
            ...
            : new Ge(h.drawingBufferWidth / g, h.drawingBufferHeight / g),
        i = null,
        u = 1;
      s.background &&
      ...
      h.bindBuffer(h.ARRAY_BUFFER, l),
        h.bufferData(h.ARRAY_BUFFER, zr * 4, h.DYNAMIC_DRAW),
        Yr.reduce(
          (f, p, x) => (
            h.vertexAttribPointer(x, p.size, h.FLOAT, !1, en * 4, f),
      ...
      h.bindBuffer(h.ELEMENT_ARRAY_BUFFER, a),
        h.bufferData(h.ELEMENT_ARRAY_BUFFER, Kr * 4, h.DYNAMIC_DRAW),
      ...
      static fromImage(n, r = {}) {
        let [i, u] = B.packer.add(n),
          l = r.frames
            ? r.frames.map(
                (a) =>
                  new Q(u.x + a.x * u.w, u.y + a.y * u.h, a.w * u.w, a.h * u.h),
              )
            : St(r.sliceX || 1, r.sliceY || 1, u.x, u.y, u.w, u.h);
    ...
    class ge {
      ...
      static fromURL(n) {
        return Vn(n)
          ? ge.fromArrayBuffer(Cr(n))
          : rn(n).then((r) => ge.fromArrayBuffer(r));
      }
    }
    o(ge, 'SoundData');
    let he = (() => {
    ...
    class ie {
      ...
      onLoad(n) {
        return (
          this.loaded && this.data ? n(this.data) : this.onLoadEvents.add(n),
          this
        );
      }
      onError(n) {
    ...
    function an(e, n, r, i, u = {}) {
      return B.bitmapFonts.add(
        e,
        Je(n).then((l) => de(K.fromImage(l, u), r, i, u.chars ?? Lr)),
      );
    }
    o(an, 'loadBitmapFont');
    function St(e = 1, n = 1, r = 0, i = 0, u = 1, l = 1) {
      let a = [],
        ...
        f = l / n;
      for (let p = 0; p < n; p++)
        for (let x = 0; x < e; x++) a.push(new Q(r + x * m, i + p * f, m, f));
      return a;
    }
    o(St, 'slice');
    function Ct(e, n) {
      ...
      return Array.isArray(n)
        ? n.some((i) => typeof i == 'string')
          ? B.sprites.add(
              ...
              Promise.all(
                n.map((i) =>
                  typeof i == 'string' ? Je(i) : Promise.resolve(i),
                ),
              ).then((i) => Tt(i, r)),
            )
          : B.sprites.addLoaded(e, Tt(n, r))
        : typeof n == 'string'
    ...
    function cn(e, n, r) {
      typeof n == 'string' &&
        !r &&
        (r = n.replace(new RegExp(`${Ar(n)}$`), 'json'));
    ...
    o(ln, 'loadShader');
    function hn(e, n, r) {
      let i = o((l) => (l ? nn(l) : Promise.resolve(null)), 'resolveUrl'),
    ...
    function gn(e) {
      return (
        e !== void 0 && (he.masterNode.gain.value = e), he.masterNode.gain.value
      );
    }
    o(gn, 'volume');
    function dt(e, n = {}) {
      ...
      return {
        set paused(O) {
          if (i !== O)
            if (((i = O), O)) x && (u.stop(), (x = !1)), (p = r.currentTime);
            else {
              u = $(u);
              let A = p - f;
              u.start(0, A), (x = !0), (f = r.currentTime - A), (p = 0);
            }
        },
        get paused() {
          return i;
    ...
    function ft(e = kn, n = _n) {
      let r = Li.replace('{{user}}', e ?? kn),
        i = Ii.replace('{{user}}', n ?? _n),
    ...
    function Be(e, n, r, i = w.defTex, u = w.defShader, l = {}) {
      ...
      (i !== w.curTex ||
        a !== w.curShader ||
        !Bn(w.curUniform, l) ||
        w.vqueue.length + e.length * en > zr ||
        w.iqueue.length + n.length > Kr) &&
        fe();
      let m = r ? w.transform : T.cam.transform.mult(w.transform);
      for (let f of e) {
        let p = It(m.multVec2(f.pos));
        w.vqueue.push(
          p.x,
          p.y,
          f.uv.x,
      ...
      for (let f of n) w.iqueue.push(f + w.vqueue.length / en - e.length);
    ...
    function fe() {
      !w.curTex ||
        ...
        h.bufferSubData(h.ELEMENT_ARRAY_BUFFER, 0, new Uint16Array(w.iqueue)),
        w.curShader.bind(),
    ...
    function Oe(e) {
      ...
      let n = e.width,
        r = e.height,
        u = ut(e.anchor || Qt).scale(new v(n, r).scale(-0.5)),
        l = e.quad || new Q(0, 0, 1, 1),
        a = e.color || W(255, 255, 255),
        m = e.opacity ?? 1,
        f = e.tex ? qr / e.tex.width : 0,
        p = e.tex ? qr / e.tex.height : 0,
        x = l.x + f,
        D = l.y + p,
        q = l.w - f * 2,
        j = l.h - p * 2;
      ...
      if (e.tiled) {
        ...
        for (let p = 0; p < l; p++)
          for (let x = 0; x < a; x++)
            Oe(
              Object.assign({}, e, {
                pos: (e.pos || new v(0)).add(new v(r * p, i * x)).sub(f),
    ...
    function Hn(e) {
      ...
      if (!(n.length < 2))
        if (e.radius && n.length >= 3) {
          ...
          pt(
            Object.assign({}, e, { p1: n[n.length - 2], p2: n[n.length - 1] }),
          );
        } else
          for (let r = 0; r < n.length - 1; r++)
            pt(Object.assign({}, e, { p1: n[r], p2: n[r + 1] })),
              e.join !== 'none' &&
                Qe(Object.assign({}, e, { pos: n[r], radius: e.width / 2 }));
    }
    o(Hn, 'drawLines');
    function qn(e) {
      if (!e.p1 || !e.p2 || !e.p3)
    ...
    function qe(e) {
      ...
      if (!(n < 3)) {
        if (
          (re(), b(e.pos), C(e.scale), ee(e.angle), b(e.offset), e.fill !== !1)
        ) {
    ...
    function $e(e) {
      ...
      let { charStyleMap: r, text: i } = Zr(e.text + ''),
        u = i.split('');
      if (n instanceof _e || typeof n == 'string') {
        let _ = n instanceof _e ? n.fontface.family : n,
          ...
          F = bn[_] ?? {
            font: {
              tex: new K(Nr, kr, { filter: H.filter }),
              map: {},
              size: Vr,
            },
            cursor: new v(0),
        ...
        for (let Ue of u)
          if (!F.font.map[Ue]) {
            ...
            if (
              F.cursor.x + P > Nr &&
              ((F.cursor.x = 0), (F.cursor.y += G), F.cursor.y > kr)
            )
...
`
      ...
      let te = [];
      for (let _ of q) {
        let H = (x - _.width) * Ni(e.align ?? 'left');
        for (let F of _.chars) {
          let Ue = n.map[F.ch],
            y = te.length;
          if (
            ((F.pos = F.pos.add(H, 0).add(Ue.w * a.x * 0.5, Ue.h * a.y * 0.5)),
            e.transform)
          ) {
            let R =
    ...
    o(ts, 'contentToView');
    function Vt() {
      return es(E.mousePos());
    }
    o(Vt, 'mousePos'),
      (Ze.error = (e) => {
        e.error ? Cn(e.error) : Cn(new Error(e.message));
      }),
    ...
    let se = {
      ...
      log: (e) => {
        ...
        T.logs.unshift(
          `${`[time]${E.time().toFixed(2)}[/time] `}[${r}]${e?.toString ? e.toString() : e}[/${r}]`,
        ),
      ...
      set paused(e) {
        (E.paused = e), e ? he.ctx.suspend() : he.ctx.resume();
      },
    };
    function Te() {
      return E.dt();
      ...
      let n = new Map(),
        ...
        l = {
          ...
          readd(a) {
            ...
            return (
              m !== -1 && (this.children.splice(m, 1), this.children.push(a)), a
            );
          },
          remove(a) {
            let m = this.children.indexOf(a);
          ...
          use(a) {
            ...
            let m = [];
            a.id &&
              (this.unuse(a.id), (r[a.id] = []), (m = r[a.id]), n.set(a.id, a));
            for (let p in a) {
              if (Vi.has(p)) continue;
              let x = Object.getOwnPropertyDescriptor(a, p);
              if (
                (typeof x.value == 'function' && (a[p] = a[p].bind(this)),
                x.set && Object.defineProperty(a, p, { set: x.set.bind(this) }),
                x.get && Object.defineProperty(a, p, { get: x.get.bind(this) }),
                ji.has(p))
              ) {
                let D =
                  p === 'add'
                    ? () => {
                        (u = o((q) => m.push(q), 'onCurCompCleanup')),
                          a[p](),
                          (u = null);
                      }
                    : a[p];
              ...
              else throw new Error(`Duplicate component property: "${p}"`);
            }
            let f = o(() => {
              if (a.require) {
            ...
            a.destroy && m.push(a.destroy.bind(this)),
              this.exists()
                ? (f(),
                  a.add &&
                    ((u = o((p) => m.push(p), 'onCurCompCleanup')),
                    a.add.call(this),
                    (u = null)))
          ...
          get(a, m = {}) {
            let f = m.recursive
              ...
              : this.children;
            if (((f = f.filter((p) => (a ? p.is(a) : !0))), m.liveUpdate)) {
              let p = o(
                (x) => (m.recursive ? this.isAncestorOf(x) : x.parent === this),
                'isChild',
              );
              xn((x) => {
                p(x) && x.is(a) && f.push(x);
    ...
    function xn(e, n) {
      if (typeof e == 'function' && n === void 0) return T.events.on('add', e);
    ...
    o(us, 'onCollideUpdate');
    function cs(e, n, r) {
      return je('collideEnd', e, (i, u, l) => u.is(n) && r(i, u, l));
    }
    o(cs, 'onCollideEnd');
    function Nt(e, n) {
      ar(e, { recursive: !0 }).forEach(n), xn(e, n);
    }
    ...
    function kt(...e) {
      return {
        ...
        screenPos() {
          return this.fixed ? this.pos : vn(this.pos);
        },
        inspect() {
      ...
      return {
        ...
        onHover(i) {
          ...
          return this.onUpdate(() => {
            u ? (u = this.isHovering()) : this.isHovering() && ((u = !0), i());
          });
        },
        onHoverUpdate(i) {
          return this.onUpdate(() => {
        ...
        onHoverEnd(i) {
          let u = !1;
          return this.onUpdate(() => {
            u ? this.isHovering() || ((u = !1), i()) : (u = this.isHovering());
          });
        },
        onCollide(i, u) {
    ...
    function En(e, n = {}) {
      ...
      let l = o((a, m, f, p) => {
        ...
        return (
          f && p
            ? ((x.x = f / (a.width * m.w)), (x.y = p / (a.height * m.h)))
            : f
    ...
    function Rs(e, n) {
      return {
        ...
        draw() {
          Oe(
            Object.assign(et(this), { width: this.width, height: this.height }),
          );
        },
        renderArea() {
          return new ne(S(0), this.width, this.height);
          ...
          this.onCollideUpdate((l, a) => {
            if (
              ...
              if (!this.isStatic && !l.isStatic) {
                ...
                (this.pos = this.pos.add(a.displacement.scale(l.mass / m))),
                  (l.pos = l.pos.add(a.displacement.scale(-this.mass / m))),
                  (this.transform = jt(this)),
                  (l.transform = jt(l));
              } else {
                let m = !this.isStatic && l.isStatic ? a : a.reverse();
                (m.source.pos = m.source.pos.add(m.displacement)),
                  (m.source.transform = jt(m.source));
              }
              (a.resolved = !0),
            ...
            this.onPhysicsResolve((l) => {
              T.gravity &&
                (l.isBottom() && this.isFalling()
                  ...
                  : l.isTop() &&
                    this.isJumping() &&
                    ((n.y = 0), this.trigger('headbutt', l.target)));
            });
        },
        update() {
          if (!T.gravity || this.isStatic) return;
          if (
            (u && ((r = null), (i = null), this.trigger('fallOff'), (u = !1)),
            r)
          )
            if (!this.isOverlapping(r) || !r.exists() || !r.is('body')) u = !0;
            else {
              !r.pos.eq(i) &&
                e.stickToPlatform !== !1 &&
          ...
          (n.y += T.gravity * this.gravityScale * Te()),
            (n.y = Math.min(n.y, e.maxVelocity ?? Fs)),
      ...
      return {
        ...
        enterState(f, ...p) {
          ...
          if (r) {
            ...
            if (!D.includes(f))
              throw new Error(
                `Cannot transition state from "${x}" to "${f}". Available transitions: ${D.map((q) => `"${q}"`).join(', ')}`,
              );
          }
          a('end', x, ...p),
            (this.state = f),
      ...
      T.events.onOnce('frameEnd', () => {
        T.events.trigger('sceneLeave', e),
          ...
          [...T.root.children].forEach((r) => {
            (!r.stay || (r.scenesToStay && !r.scenesToStay.includes(e))) &&
              T.root.remove(r);
          }),
          T.root.clearEvents(),
          (T.cam = {
        ...
        $ = o(() => {
          ...
          for (let R of r.children) {
            ...
            (R.tilePos.x != P.x || R.tilePos.y != P.y) &&
              ((y = !0), j(R), (R.tilePos.x = P.x), (R.tilePos.y = P.y), q(R));
          }
        ...
        Ue = {
          ...
          spawn(y, ...R) {
              ...
              G = (() => {
                if (typeof y == 'string') {
                  if (n.tiles[y]) {
                    ...
                    return n.tiles[y](P);
                  } else if (n.wildcardTile) return n.wildcardTile(y, P);
                } else {
            ...
            let N = !1,
              Y = !1;
            for (let me of G)
              me.id === 'tile' && (Y = !0), me.id === 'pos' && (N = !0);
            N || G.push(kt()), Y || G.push(or());
            let oe = r.add(G);
            return (
          ...
          getTilePath(y, R, P = {}) {
            ...
            for (me.set(G, 0); Y.length !== 0; ) {
              ...
              for (let Ke of On) {
                ...
                (!me.has(Ke) || Pn < me.get(Ke)) &&
                  (me.set(Ke, Pn),
                  Y.insert({ cost: Pn, node: Ke }),
                  oe.set(Ke, Le));
              }
            }
            let An = [],
          ...
          getPath(y, R, P = {}) {
            let G = this.tileWidth(),
              N = this.tileHeight(),
              Y = this.getTilePath(this.pos2Tile(y), this.pos2Tile(R), P);
            return Y
              ? [
                  y,
                  ...Y.slice(1, -1).map((oe) =>
    ...
    o(Xs, 'agent');
    function Ws(e) {
      let n = E.canvas().captureStream(e),
    ...
    let bt = T.root.add.bind(T.root),
      Zs = T.root.readd.bind(T.root),
      ei = T.root.removeAll.bind(T.root),
    ...
    function ri(e, n = {}) {
      let r = bt([kt(e), rr()]),
        i = (n.speed || 1) * 5,
        u = n.scale || 1;
      r.add([En(ni), _t(0), Un('center'), ur(i, u), ...(n.comps ?? [])]);
      let l = r.add([En(ti), _t(0), Un('center'), nr(), ...(n.comps ?? [])]);
      return (
            ...
            for (let O = x; O <= q; O++)
              if (!e[$]) (e[$] = {}), (e[$][O] = [a]);
                ...
                e: for (let te of A) {
                  ...
                  for (let H of a.collisionIgnore) if (te.is(H)) continue e;
                  for (let H of te.collisionIgnore) if (a.is(H)) continue e;
                  let _ = Sr(a.worldArea(), te.worldArea());
                  if (_) {
                    let H = new qt(a, te, _);
    ...
    function ii() {
      let e = T.cam,
        n = v.fromAngle(Ut(0, 360)).scale(e.shake);
      (e.shake = Me(e.shake, 0, 5 * Te())),
        (e.transform = new J()
          .translate(Ht())
          .scale(e.scale)
          .rotate(e.angle)
          .translate((e.pos ?? Ht()).scale(-1).add(n))),
        T.root.draw(),
        fe();
    }
    o(ii, 'drawFrame');
    function oi() {
      ...
      T.events.numListeners('loading') > 0
        ...
        : Ve(() => {
            ...
            Ce({ pos: S(0), width: we(), height: ye(), color: W(0, 0, 0) }),
              Ce({
                pos: i,
                width: n,
                height: r,
    ...
    function ai() {
      if (se.inspect) {
        ...
        if ((T.root.drawInspect(), e)) {
          let n = [],
            r = e.inspect();
          for (let i in r) r[i] ? n.push(`${i}: ${r[i]}`) : n.push(`${i}`);
          lr(
            ts(Vt()),
            n.join(`
`),
          ...
          Ve(() => {
            ...
            for (let r = 0; r < 2; r++) {
              ...
              qn({
                ...
                p3: S(-n.width - e * (i ? 3.5 : 2), -e - n.height / 2),
...
`),
    ...
    o(ai, 'drawDebug'), s.debug !== !1 && er(), s.burp && tr();
    function ui(e) {
    ...
    E.run(() => {
      Bt(),
        B.loaded ||
          (Fe() === 1 && !$t && ((B.loaded = !0), T.events.trigger('load'))),
        (!B.loaded && s.loadingScreen !== !1) || $t
          ? oi()
          : (se.paused || cr(), si(), ii(), s.debug !== !1 && ai()),
        $t && ($t = !1),
        Lt(),
